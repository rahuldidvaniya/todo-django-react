...
from .views import ProjectCreateView, ProjectListView, TodoCreateView, TodoListView, TodoDeleteView, ProjectDeleteView, ToggleTodoCompleted, EditProject, EditTodo
...
urlpatterns = [
    ...
    path("api/projects/edit/<int:id>/", EditProject.as_view(),  name="edit-project"),
    path("api/todos/edit/<int:id>/", EditTodo.as_view(), name="edit-todo"),
